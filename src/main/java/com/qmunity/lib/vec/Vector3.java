...
public class Vector3 {
    ...
    public static Vector3[] rotationAxes = { new Vector3(0.0D, -1.0D, 0.0D), new Vector3(0.0D, 1.0D, 0.0D), new Vector3(0.0D, 0.0D, -1.0D),
            new Vector3(0.0D, 0.0D, 1.0D), new Vector3(-1.0D, 0.0D, 0.0D), new Vector3(1.0D, 0.0D, 0.0D) };
    ...
    public Vector3(BlockCoord coord, World w) {
